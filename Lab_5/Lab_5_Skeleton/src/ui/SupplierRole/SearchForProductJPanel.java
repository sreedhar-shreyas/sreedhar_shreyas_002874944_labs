...
public class SearchForProductJPanel extends javax.swing.JPanel {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        layout.next(userProcessContainer);
            ...
            JOptionPane.showMessageDialog(null, "Nothing found", "No result found matching your searhc", JOptionPane.WARNING_MESSAGE);
            //return;
        }
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null, "Nothing found", "No result found matching your search", JOptionPane.WARNING_MESSAGE);
        }
